MATRIXVBS_paper.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

MATRIXVBS_paper: E6TmatrixF40 with nudging and VBS!
...
!! OFFLINE_AERO only needed for coupled_chem .ne. 1:
!! OFFLINE_AERO=giss2/sample2_for_coupled_chem_zero_144x90x40.nc
...
MATRIXVBS_paper (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
...
!variable_orb_par=0
!orb_par_year_bp=-50 !BP i.e. 1950-orb_par_year_bp AD = 2000 AD
MADVOL=2
!!!!!!!!!!!!!!!!!!!!!!!
...
KRSF=0           ! 0: no output; X: save rsf at the beginning of every X month
...
&INPUTZ
 YEARI=2012,MONTHI=12,DATEI=1,HOURI=0, ! pick IYEAR1=YEARI (default) or < YEARI
 YEARE=2018,MONTHE=1,DATEE=1,HOURE=0,     KDIAG=12*0,9,
 ISTART=2,IRANDI=0, YEARE=2012,MONTHE=12,DATEE=1,HOURE=1,
/
