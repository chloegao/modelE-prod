ygMV_clim2015em1850_BBctrl.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

ygMV_clim2015em1850_BBctrl: E6TmatrixF40clim but year 2000 settings
...
ygMV_clim2015em1850_BBctrl (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
