ygMV_emiss2019_BBlow.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

ygMV_emiss2019_BBlow: E6TmatrixF40 with nudging and VBS
...
ygMV_emiss2019_BBlow (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
...
VBSemifactBB=0.06d0,0.12d0,0.18d0,0.28d0,0.36d0,0.0d0,0.0d0,0.0d0,0.0d0
