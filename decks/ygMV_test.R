ygMV_test.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

ygMV_test: E6TmatrixF40 with nudging and VBS
...
ygMV_test (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
