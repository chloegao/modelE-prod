ygMV_transient_BBctrl.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

ygMV_transient_BBctrl: E6TmatrixF40 with nudging and VBS
...
ygMV_transient_BBctrl (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
