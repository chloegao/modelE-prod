ygM_transient.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm MATRIX tracers

ygM_transient: E6TmatrixF40 with nudging
...
ygM_transient (climatological prescribed ocean atmospheric tracer model with MATRIX and Shindell chemistry)
