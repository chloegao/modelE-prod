...
!
#ifndef SPECIFY_MU_SCALE
!@dbparam CMC parameter for GW M. Convective drag (in param. database)
C**** (used to be FMC)
#else 
!@dbparam CMC parameter for GW M. Convective drag (removed from namelist)
!@dbparam SCVMU parameter to Scale the Convective MUs (in param. database)
      REAL*8 :: SCVMU = 0.188
      REAL*4 :: SCVMU4 = 0.1880
#endif
!
...
#ifdef SPECIFY_MU_SCALE
          IF (WTX.GT.1.50 .OR. WTX.LT.0.) THEN
#endif
...
cc      MU(4)=MU(3)
        ...
        MU(4) = MU3HOLD * 0.1880  
#else
        MU(3) = MU3HOLD * SCVMU  !  4
        MU(4) = MU3HOLD * SCVMU  !  4
#endif
        CN(3)=WSRC-10.
        CN(4)=WSRC+10.
        UR(4)=UR(3)
...
#ifndef SPECIFY_MU_SCALE 
        MU(3+7) = MU37HOLD * 0.1880   
        MU(4+7) = MU37HOLD * 0.1880   
#else
        MU(3+7) = MU37HOLD * SCVMU  !  4
        MU(4+7) = MU37HOLD * SCVMU  !  4
#endif
        CN(3+7) = WSRC-10. 
        CN(4+7) = WSRC+10. 
        UR(4+7) = UR(3+7) 
...
C 
        ...
        MU(8) = MU3HOLD * 0.1880   
#else
        MU(7) = MU3HOLD * SCVMU  !  4
        MU(8) = MU3HOLD * SCVMU  !  4
#endif
        MU(5+7) = 0.0 
        MU(6+7) = 0.0 
#ifndef SPECIFY_MU_SCALE 
        MU(7+7) = MU37HOLD * 0.1880  
        MU(8+7) = MU37HOLD * 0.1880  
#else
        MU(7+7) = MU37HOLD * SCVMU  !  4
        MU(8+7) = MU37HOLD * SCVMU  !  4
#endif
        END IF 
C
