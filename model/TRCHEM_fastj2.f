...
!@auth Kostas Tsigaridis
     ...
     &           trim(ate(2))//'_'//trim(ate(3))
      ...
      select case(reaction)
        ...
        case('d17OPAN__C2O3_NO2')
          rj%d17OPAN__C2O3_NO2=irr
        ...
        case('d18OPAN__C2O3_NO2')
          rj%d18OPAN__C2O3_NO2=irr
        ...
        case('d13CPAN__C2O3_NO2')
          rj%d13CPAN__C2O3_NO2=irr
