! These subroutines are used to read/write arrays (distributed and
...
! I/O Interfaces
     ...
     &     ,get_record_dimlen,get_dimlen,get_dimlens,get_record_dimname
      ...
      ! subroutine Write a distributed array to a correesponding NetCDF variable on disk.
      ! (after defvar() has been called).
      !
      ...
      ! subroutine read_dist_data(grid,fid,varname,arr,jdim,no_xdim,record,record1)
      ! ---------------------------------------------------
      !
      ...
      ! subroutine write_data(grid,fid,varname,arr)
      ! --------------------------------
      !
      ...
      interface read_data
      ! subroutine read_data(grid,fid,varname,arr,bcast_all)
      ! --------------------------------
      !
      ! Write a non-dstributed array to a correesponding NetCDF variable
      ! on disk.  (after defvar() has been called).  The array is
      ...
      !           interface does not yet exist, it should be added.
      !
      ! logical, intent(in), optional :: bcast_all = .false.
      ...
      public :: defvar
      interface defvar
      ! subroutine defvar(grid,fid,arr,varinfo,r4_on_disk,defby)
      ! --------------------------------------------------------
      !
