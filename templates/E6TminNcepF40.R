E6TminF40.R GISS Model E  2000 ocn/atm OMA dust mineral tracers only, NCEP

E6TminF40: based on E6TomaF40. OMA tracers with computed dust minerals only
  + winds nudged toward NCEP
...
E6TminF40 (prescribed ocean atmospheric tracer model with OMA minerals only, nudged)
