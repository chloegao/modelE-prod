E6TomaF40meg.R GISS ModelE Lat-Lon Atmosphere Model, climatological ocn/atm OMA tracers

E6TomaF40meg = E6TomaF40clim with megan (isoprene) source turned on for testing
...
E6TomaF40meg (climatological prescribed ocean atmospheric tracer model with OMA and Shindell chemistry, MEGAN emis)
